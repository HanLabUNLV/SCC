...
# Step 2 Intersect regions for different cell types
 ...
 ## ALL REGIONS
 bedtools intersect -a hela_labelled_200bp_window.bed -b endo_labelled_200bp_window.bed -wao > network_200bp_window_hela_endo.bed
 bedtools intersect -a hela_labelled_200bp_window.bed -b hff_labelled_200bp_window.bed -wao > network_200bp_window_hela_hff.bed
 bedtools intersect -a hela_labelled_200bp_window.bed -b h1_labelled_200bp_window.bed  -wao > network_200bp_window_hela_h1.bed
# 
