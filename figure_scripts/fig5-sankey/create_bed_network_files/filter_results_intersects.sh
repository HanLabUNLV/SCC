...
# ## ALL REGIONS
# bedtools intersect -a h1_labelled.bed -b endo_labelled.bed hela_labelled.bed  hff_labelled.bed -wao > network_h1.bed
# bedtools intersect -a endo_labelled.bed -b h1_labelled.bed hela_labelled.bed  hff_labelled.bed -wao > network_endo.bed
# bedtools intersect -a hela_labelled.bed -b endo_labelled.bed h1_labelled.bed  hff_labelled.bed -wao > network_hela.bed
# bedtools intersect -a hff_labelled.bed -b endo_labelled.bed h1_labelled.bed hela_labelled.bed  -wao > network_hff.bed
# 
 bedtools intersect -a hela_labelled.bed -b endo_labelled.bed -wao > network_hela_endo.bed
 bedtools intersect -a hela_labelled.bed -b hff_labelled.bed -wao > network_endo_hff.bed
 bedtools intersect -a hela_labelled.bed -b h1_labelled.bed  -wao > network_hff_hela.bed
